...
io.popen("cd library && wget https://raw.githubusercontent.com/Mikasa-DEV/Mikasa/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Mikasa-DEV/Files_Mikasa/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevMikasaW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMikasaW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMikasaW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMikasaW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMikasaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMikasaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMikasaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local Mikasa_Msg = ''  
if msgs < 100 then 
Mikasa_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Mikasa_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Mikasa_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Mikasa_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Mikasa_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Mikasa_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Mikasa_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Mikasa_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Mikasa_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Mikasa_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Mikasa_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Mikasa_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Mikasa_Msg = 'رب التفاعل'  
end 
return Mikasa_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceMikasa(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."Mikasa1:List:Filter"..sl)
...
if not DevMikasaW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevMikasaW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,Mikasa_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ᥀' and DevMikasaW(msg) then  
...
if text == 'تعطيل التواصل ᥀' and DevMikasaW(msg) then  
...
if text == 'تفعيل البوت الخدمي ᥀' and DevMikasaW(msg) then  
...
if text == 'تعطيل البوت الخدمي ᥀' and DevMikasaW(msg) then  
...
if text == 'ضع كليشه ستارت ᥀' and DevMikasaW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *᥀︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ᥀' and DevMikasaW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *᥀︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ᥀' and DevMikasaW(msg) then 
...
if text == 'تحديث السورس ᥀' and DevMikasaW(msg) then 
os.execute('rm -rf Mikasa.lua')
os.execute('wget https://raw.githubusercontent.com/Mikasa-DEV/Mikasa/main/Mikasa.lua')
send(msg.chat_id_, msg.id_,' *᥀︙تم تحديث السورس* \n*᥀︙لديك اخر اصدار لسورس سناب*\n*᥀︙الاصدار » { 2.8v}*')
dofile('Mikasa.lua')  
end
if text == 'الاصدار ᥀' and DevMikasaW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *᥀︙اصدار سورس سناب* \n*᥀︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ᥀' and DevMikasaW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ᥀︙[تحديثات البوت](t.me/LZZZ5) \n᥀︙[قناه السورس](t.me/rrrrwv)')
end
if text == "ضع اسم للبوت ᥀" and DevMikasaW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *᥀︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ᥀' and DevMikasaW(msg) then 
...
if text == 'المشتركين ᥀' and DevMikasaW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *᥀︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ᥀' and DevMikasaW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *᥀︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ᥀") and DevMikasaW(msg) then
...
if text == ("قائمه العام ᥀") and DevMikasaW(msg) then
...
if text == ("قائمه الكتم العام ᥀") and DevMikasaW(msg) then
...
if text=="اذاعه خاص ᥀" and msg.reply_to_message_id_ == 0 and DevMikasaW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *᥀︙ارسل الان اذاعتك؟* \n*᥀︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ᥀" and msg.reply_to_message_id_ == 0 and DevMikasaW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *᥀︙ارسل الان اذاعتك؟* \n*᥀︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ᥀" and msg.reply_to_message_id_ == 0 and DevMikasaW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *᥀︙ارسل الان اذاعتك؟* \n*᥀︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ᥀" and msg.reply_to_message_id_ == 0  and DevMikasaW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *᥀︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ᥀" and msg.reply_to_message_id_ == 0  and DevMikasaW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ᥀︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ᥀' and DevMikasaW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ᥀" and DevMikasaW(msg) then
...
if text == "تنظيف الكروبات ᥀" and DevMikasaW(msg) then 
...
send(msg.chat_id_, msg.id_,'*᥀︙عدد الكروبات الان » { '..#group..' }'..Mikasak..''..Mikasa..'*\n*᥀︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevMikasaW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevMikasaW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMikasaW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMikasaW(msg) then
...
local Mikasa1_Msg = database:get(bot_id.."Mikasa1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Mikasa1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if Mikasa_Msg and not Special(msg) then  
local Mikasa_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Mikasa_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevMikasaW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMikasaW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevMikasaW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *᥀︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevMikasaW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *᥀︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ᥀" and DevMikasaW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *᥀︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ᥀$") and DevMikasaW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *᥀︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ᥀" and DevMikasaW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ᥀" and DevMikasaW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *᥀︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ᥀" and DevMikasaW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."Mikasa:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Mikasa:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Mikasa = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Mikasa then 
names_Mikasa = database:smembers(bot_id.."Mikasa:blocname"..msg.chat_id_) or ""
if names_Mikasa and names_Mikasa[1] then 
for i=1,#names_Mikasa do 
if name_Mikasa:match("(.*)("..names_Mikasa[i]..")(.*)") then 
...
database:set(bot_id.."Mikasa:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Mikasa:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Mikasa:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Mikasa:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Mikasa:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Mikasaa_new(Mikasa1,Mikasa2)
if Mikasa2 and Mikasa2.first_name_ then 
if Mikasa2.first_name_:match("(.*)"..database:get(bot_id.."Mikasa:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Mikasa:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Mikasa_nnn = database:get(bot_id.."Mikasa:nump"..msg.chat_id_) or 5
local Mikasa_nnn2 = database:get(bot_id.."Mikasa:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Mikasa_nnn2) == tonumber(Mikasa_nnn) or tonumber(Mikasa_nnn2) > tonumber(Mikasa_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Mikasa:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "᥀︙عزيزي >>["..Mikasa2.username_.."](https://t.me/"..(Mikasa2.username_ or "rrrrwv")..")\n᥀︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Mikasa:teh"..msg.chat_id_).."} بجانب اسمك\n᥀︙عدد المحاولات المتبقيه {"..(tonumber(Mikasa_nnn) - tonumber(Mikasa_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Mikasaa_new)
end
end
...
local MikasaChengName = database:get(bot_id.."Mikasa:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MikasaChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MikasaChengName..']')
database:del(bot_id.."Mikasa:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MikasaChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Mikasa:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MikasaChengUserName = database:get(bot_id.."Mikasa:Cheng:UserName"..data.id_)
if not data.username_ then 
if MikasaChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MikasaChengUserName..']')
database:del(bot_id.."Mikasa:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MikasaChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Mikasa:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MikasaChengPhoto = database:get(bot_id.."Mikasa:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MikasaChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Mikasa:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MikasaChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Mikasa:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevMikasaW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevMikasaW(msg) then
dofile('Mikasa.lua')  
send(msg.chat_id_, msg.id_, ' *᥀︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevMikasaW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMikasaW(msg) then  
function start_function(extra, result, success)
if MikasaSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevMikasaW(msg) then  
...
if MikasaSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*᥀︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevMikasaW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if MikasaSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*᥀︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMikasaW(msg) then  
function start_function(extra, result, success)
if MikasaSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*᥀︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevMikasaW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevMikasaW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if MikasaSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*᥀︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMikasaW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevMikasaW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevMikasaW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevMikasaW(msg) then
...
if text == 'الملفات' and DevMikasaW(msg) then
t = ' *᥀︙ملفات السورس سناب ↓*\n*•━━━━━━ 𝙎𝘽 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevMikasaW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Mikasa-DEV/Files_Mikasa/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevMikasaW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Mikasa-DEV/Files_Mikasa/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevMikasaW(msg) then
...
if text == "مسح الملفات" and DevMikasaW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *᥀︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMikasaW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMikasaW(msg) then  
function start_function(extra, result, success)
...
database:set(bot_id.."Mikasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Mikasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *᥀︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."Mikasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Mikasa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Mikasa1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Mikasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *᥀︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."Mikasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Mikasa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Mikasa1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Mikasa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *᥀︙ارسل الكلمه الان*")  
database:set(bot_id.."Mikasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Mikasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Mikasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Mikasa1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Mikasa1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Mikasa1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Mikasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Mikasa1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Mikasa1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevMikasaW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *᥀︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevMikasaW(msg) then
...
if text == 'تفعيل الاذاعه' and DevMikasaW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevMikasaW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..Mikasa_Msg[math.random(#Mikasa_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevMikasaW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,Mikasa)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝙎𝘽 ━━━━━━━•*\n"
x = 0
local list = Mikasa.members_
for k, v in pairs(list) do
x = x + 1
...
if MikasaSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevMikasaW(msg) then 
...
if text == ("ردود المطور") and DevMikasaW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ᥀︙قائمة ردود المطور \n*•━━━━━━ 𝙎𝘽 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevMikasaW(msg) then    
send(msg.chat_id_, msg.id_,' *᥀︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevMikasaW(msg) then    
...
if text == 'تفعيل المغادره' and DevMikasaW(msg) then   
...
if text == 'تعطيل المغادره' and DevMikasaW(msg) then  
...
-- vardump(data) 
Mikasadx(msg.chat_id_, msg.id_, ' *᥀︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*᥀︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*᥀︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*᥀︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevMikasaW(msg) then
...
Mikasa = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Mikasa)
...
--------------------------------------------------------------------------------------------------------------
SourceMikasa(data.message_,data)
...
------------------------------------------------------------------------
local MikasaAbot = database:get(bot_id.."Mikasa1:Add:Filter:Rp2"..text..result.chat_id_)   
if MikasaAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *᥀︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n᥀︙["..MikasaAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Mikasa1_Msg = database:get(bot_id.."Mikasa1:Add:Filter:Rp2"..text..result.chat_id_)   
if Mikasa1_Msg then
send(msg.chat_id_, msg.id_," ᥀︙"..Mikasa1_Msg)
